...
import { inject, getCurrentInstance, defineComponent, h, ref, computed, isVue2, reactive, onUnmounted } from 'vue-demi';
...
var script$d = defineComponent({
    render: function () {
        ...
        var createPath = function (attrs) {
            return h("path", __assign(__assign({}, attrs), { attrs: attrs }));
        };
        return h("svg", __assign(__assign({}, svgAttrs), { attrs: svgAttrs }), [createPath(path1Attrs), createPath(path2Attrs)]);
    },
});
...
var script$b = defineComponent({
    ...
    setup: function (props) {
        ...
        var setExpandedPages = function (index) {
            if (expandedPages.value.includes(index)) {
                ...
                expandedPages.value = __spreadArray(__spreadArray([], expandedPages.value), [index]);
            }
        };
        return {
            theme: theme,
    ...
    render: function () {
        ...
        var multiPage = h("div", {
            ...
            return h("div", {
                ...
                h(script$c, {
                    ...
                    title: "[" + index * _this.pageSize + " ... " + (index * _this.pageSize + _this.pageSize - 1) + "]",
        ...
        }, __spreadArray([root, expanded], (!((_b = this.subEntryPages) === null || _b === void 0 ? void 0 : _b.length) ? noPages : [])));
    },
});
...
var getSortedQueries = function (queryCache, filterOptions) {
    ...
    var sorted = __spreadArray([], queries).sort(filterOptions.sortFn);
...
export { VUE_QUERY_DEVTOOLS_THEME, script as VueQueryDevTools, script$3 as VueQueryDevToolsPanel };
