...
function dehydrate(client, options) {
    ...
    if ((options === null || options === void 0 ? void 0 : options.dehydrateMutations) !== false) {
        var shouldDehydrateMutation_1 = options.shouldDehydrateMutation || defaultShouldDehydrateMutation;
        client
            .getMutationCache()
            .getAll()
            .forEach(function (mutation) {
            if (shouldDehydrateMutation_1(mutation)) {
                mutations.push(dehydrateMutation(mutation));
            }
        });
    }
    if ((options === null || options === void 0 ? void 0 : options.dehydrateQueries) !== false) {
        var shouldDehydrateQuery_1 = options.shouldDehydrateQuery || defaultShouldDehydrateQuery;
        client
            .getQueryCache()
            .getAll()
            .forEach(function (query) {
            if (shouldDehydrateQuery_1(query)) {
...
function hydrate(client, dehydratedState, options) {
    ...
    mutations.forEach(function (dehydratedMutation) {
        var _a;
        mutationCache.build(client, __assign(__assign({}, (_a = options === null || options === void 0 ? void 0 : options.defaultOptions) === null || _a === void 0 ? void 0 : _a.mutations), { mutationKey: dehydratedMutation.mutationKey }), dehydratedMutation.state);
    });
    queries.forEach(function (dehydratedQuery) {
        ...
        queryCache.build(client, __assign(__assign({}, (_a = options === null || options === void 0 ? void 0 : options.defaultOptions) === null || _a === void 0 ? void 0 : _a.queries), { queryKey: dehydratedQuery.queryKey, queryHash: dehydratedQuery.queryHash }), dehydratedQuery.state);
    });
}
...
function useBaseQuery(options, Observer) {
    ...
    var suspense = function () { return observer.fetchOptimistic(defaultedOptions); };
...
function useQueries(queries) {
    var _a;
    var queryClientKey = (_a = queries[0]) === null || _a === void 0 ? void 0 : _a.queryClientKey;
...
export { InfiniteQueryObserver, MutationCache, MutationObserver, QueriesObserver, QueryCache, QueryClient, QueryObserver, VUE_QUERY_CLIENT, dehydrate, hydrate, parseFilterArgs, parseMutationArgs, parseQueryArgs, useInfiniteQuery, useIsFetching, useIsMutating, useMutation, useQueries, useQuery, useQueryClient, useQueryProvider };
