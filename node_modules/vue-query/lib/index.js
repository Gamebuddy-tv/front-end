...
function useQueryClient(id) {
    ...
    var suffix = id ? ":" + id : "";
    var queryClient = vueDemi.inject(VUE_QUERY_CLIENT + suffix);
    if (!queryClient) {
...
function useQueryProvider(arg1, id) {
    ...
    client.mount();
    vueDemi.provide(VUE_QUERY_CLIENT + suffix, client);
...
function useQueries(queries) {
    ...
    var unsubscribe = observer.subscribe(function (result) {
        result.forEach(function (resultEntry, index) {
            vueDemi.set(state, index, resultEntry);
        });
    });
    vueDemi.watch(function () { return queries; }, function () {
